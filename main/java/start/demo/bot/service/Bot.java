package start.demo.bot.service;

import start.demo.bot.config.BotConfig;
import start.demo.bot.dto.MenuStatus;
import start.demo.bot.dto.UserSettingsDto;
import start.demo.bot.models.UserSettings;
import start.demo.bot.util.BotText;
import start.demo.bot.util.MessageHandler;
...
import static start.demo.bot.dto.MenuStatus.*;
...
public class Bot extends AbilityBot {
    ...
    @Value("Chinchanchonchin")
    private String creatorIdString;

    // Constructor or method where you parse the value
    public void parseCreatorId() {
        this.creatorId = Long.parseLong(creatorIdString);
    ...
    public long creatorId() {
        return Long.parseLong(String.valueOf(this.creatorId));
    }
