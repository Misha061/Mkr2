...
import start.demo.bot.config.OpenWeatherConfig;
import start.demo.bot.dto.CityDto;
import start.demo.bot.dto.WeatherDto;
import start.demo.bot.dto.forecast.ForecastDetails;
import start.demo.bot.dto.forecast.ForecastDto;
import start.demo.bot.util.BotText;
import start.demo.bot.util.Converter;
